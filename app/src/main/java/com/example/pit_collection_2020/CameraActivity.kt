...
class CameraActivity : AppCompatActivity(), LifecycleOwner {
    ...
    private fun putExtras(intentToPit: Intent): Intent {
    ...
    private fun finishButton(teamNum: String) {
        btn_return.setOnClickListener {
            startActivity(
                putExtras(Intent(this, PitCollectionActivity::class.java)),
    ...
    private fun startCamera(teamNum: String) {
        ...
        capture_button.setOnClickListener {
            val pictureType = picture_type.getSelectedItem().toString().toLowerCase(Locale.US)
                            ...
                            override fun run() {
                                startActivity(
                                    putExtras(
                                        Intent(
                                            this@CameraActivity,
                                            PictureConfirmation::class.java
                                        )
