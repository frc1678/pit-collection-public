...
class CollectionObjectiveActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
        ...
        btn_save_button.setOnClickListener {
            ...
            when {
                ...
                spin_drivetrain_motor_type.selectedItem.toString() == "Drivetrain Motor Type" -> {
                    ...
                    //TODO Move below code to CollectionObjectiveActivity and link to save button

                    assignIndexNums()

                    // Save variable information as a pitData class.
                    val information = DataObjective(
                        teamNum,
                        crossTrench,
                        indexNumDrivetrain,
                        hasGroundIntake,
